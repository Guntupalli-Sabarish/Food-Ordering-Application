...
export const AppFooter = () => (
  <footer className="border-t border-border bg-card/80 backdrop-blur-sm mt-8">
    {/* Main footer grid */}
      ...
      <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed max-w-[200px]">
            Delivering great food experiences right to your door — fast, fresh, and delightful.
          </p>
          {/* Social icons */}
          <div className="flex items-center gap-2">
            {socialLinks.map(({ svg, href, label }) => (
              <a
                ...
                href={href}
                aria-label={label}
                className="flex h-8 w-8 items-center justify-center rounded-full border border-border bg-secondary/50 text-muted-foreground transition-all hover:border-brand-500/50 hover:bg-brand-500/10 hover:text-brand-500"
              >
                {svg}
              </a>
            ))}
        ...
        {/* Column 2 – Navigation */}
        <div className="space-y-4">
          <p className="text-sm font-bold uppercase tracking-wider text-foreground">Navigation</p>
        ...
        {/* Column 4 – Contact */}
        <div className="space-y-4">
          <p className="text-sm font-bold uppercase tracking-wider text-foreground">Contact</p>
          <ul className="space-y-3">
            <li className="flex items-start gap-2.5">
              <Mail className="mt-0.5 h-4 w-4 shrink-0 text-brand-500" />
              <a
                href="mailto:support@foodflow.app"
            ...
            <li className="flex items-start gap-2.5">
              ...
              <span className="text-sm text-muted-foreground">1800-123-FOOD</span>
            </li>
            <li className="flex items-start gap-2.5">
